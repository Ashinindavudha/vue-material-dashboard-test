      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">
              {{ $t('global.table') }}
              <strong>{{ $t('cruds.bikkhuParajika.title') }}</strong>
            </h4>
          </div>
          <div class="card-body">
            <router-link
...
export default {
  ...
  data() {
    return {
      ...
      xprops: {
        ...
        permission_prefix: 'bikkhu_parajika_'
      }
    }
  },
  beforeDestroy() {
  ...
  computed: {
    ...mapGetters('BikkhuParajikasIndex', ['data', 'total', 'loading'])
  },
  watch: {
    query: {
      handler(query) {
  ...
  methods: {
    ...mapActions('BikkhuParajikasIndex', [
      'fetchIndexData',
      'setQuery',
      'resetState'
    ])
