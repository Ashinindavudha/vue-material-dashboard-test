      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">
              {{ $t('global.table') }}
              <strong>{{ $t('cruds.bikkhuNidana.title') }}</strong>
            </h4>
          </div>
          <div class="card-body">
            <!-- <router-link
              class="btn btn-primary"
              v-if="xprops.permission_prefix + 'create'"
...
export default {
  ...
  computed: {
    ...mapGetters("BikkhuNidanasIndex", ["data", "total", "loading"]),
  },
  watch: {
    query: {
      handler(query) {
