...
const actions = {
  ...
  setMyanmarTraslate({ commit }, value) {
    commit('setMyanmarTraslate', value)
  },
...
const mutations = {
  ...
  setMyanmarTraslate(state, value) {
    state.entry.myanmar_traslate = value
  },
