...
const actions = {
  ...
  setMyanmarTranslte({ commit }, value) {
    commit('setMyanmarTranslte', value)
  },
...
const mutations = {
  ...
  setMyanmarTranslte(state, value) {
    state.entry.myanmar_translte = value
  },
