function initialState() {
  return {
    entry: {
      ...
      nissaya: '',
      myanmar_translate: '',
      english_translateenglish_translate: '',
      commentary: '',
      created_at: '',
      updated_at: '',
      deleted_at: ''
...
const actions = {
  ...
  setEnglishTranslateenglishTranslate({ commit }, value) {
    commit('setEnglishTranslateenglishTranslate', value)
  },
...
const mutations = {
  ...
  setEnglishTranslateenglishTranslate(state, value) {
    state.entry.english_translateenglish_translate = value
  },
