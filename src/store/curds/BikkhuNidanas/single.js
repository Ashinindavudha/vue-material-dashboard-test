...
const actions = {
  ...
  setEnglisTranslate({ commit }, value) {
    commit('setEnglisTranslate', value)
  },
...
const mutations = {
  ...
  setEnglisTranslate(state, value) {
    state.entry.englis_translate = value
  },
